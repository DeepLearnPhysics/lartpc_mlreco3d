...
def test_unwrap_mink(dim, num_device=4, minibatch_size=8):
    from mlreco.utils import unwrap_3d_mink

    unwrapper = {3:unwrap_3d_mink}
...
def test_unwrap_scn(dim, num_device=4, minibatch_size=8):
    ...
    from mlreco.utils import unwrap_3d_scn, unwrap_2d_scn, unwrap_3d_mink
