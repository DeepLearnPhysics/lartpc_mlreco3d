...
def detector_traces(boundary_file, meta=None, to_pixel=False, shared_legend=True, legend_prefix='Detector', color='rgba(0,0,0,0.150)',  **kwargs):
    '''
    ...
    legend_prefix : Union[str, List[str]]
    ...
    **kwargs : dict, optional
    ...
    detectors = box_traces(boundaries[...,0], boundaries[...,1], color=color, **kwargs)
