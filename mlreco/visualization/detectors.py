...
def detector_traces(boundaries, meta=None, detector_coords=True, draw_faces=False, shared_legend=True, legend_prefix='Detector', color='rgba(0,0,0,0.150)', linewidth=2, **kwargs):
    '''
